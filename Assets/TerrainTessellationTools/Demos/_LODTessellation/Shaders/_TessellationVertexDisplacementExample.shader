Shader "TerrainTessellationTools/TessellationVertexDisplacementExample"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        {
            CGPROGRAM
            // You need to remove #pragma vertex YourVertexProgram. This is because the vertex program is made in TessellationInput.cginc. 
            ...
            struct VertexData
            {
                ...
                float4 tangent : TANGENT;       // Any other properties from appdata (In this case named VertexData) required for the vertex program, must be integrated inside TessellationInputExample.cginc and TessellationExample.cginc, check inside of them.
            };
            ...
            {
                float3 col = float3(i.vertexPropertyExample);
