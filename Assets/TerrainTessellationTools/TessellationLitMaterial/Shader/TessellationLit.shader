Shader "TerrainTessellationTools/TessellationLit"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Includes
            #include "TessellationLitInput.hlsl"
            #include "TessellationLitGBufferPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "TessellationLitInput.hlsl"
            #include "TessellationLitDepthNormalsPass.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            // Includes
            #include "TessellationLitInput.hlsl"
            #include "TessellationLitMetaPass.hlsl"
        ...
        Pass
        {
            ...
            // Includes
            #include "TessellationLitInput.hlsl"
            #include "TessellationUniversal2D.hlsl"
            ENDHLSL
        }
    }
