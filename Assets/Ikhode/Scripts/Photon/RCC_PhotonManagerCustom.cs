...
public class RCC_PhotonManagerCustom : MonoBehaviourPunCallbacks {

    public static RCC_PhotonManagerCustom Instance;
    ...
    private void Start() {
        ...
        nickPanel.text = PlayerPrefs.GetString("OAuth_Name", "New Player " + Random.Range(0, 99999).ToString());
